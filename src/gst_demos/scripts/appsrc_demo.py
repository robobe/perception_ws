...
PIPELINE = "v4l2src name=x device=/dev/video4 ! video/x-raw,width=640,height=512,framerate=9/1 ! videoconvert ! textoverlay text='counter: 0' valignment=top ! queue max-size-buffers=1 leaky=downstream ! videorate ! video/x-raw, framerate=2/1 ! fpsdisplaysink"
